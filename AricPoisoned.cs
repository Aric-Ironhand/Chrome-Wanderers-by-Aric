...
namespace XRL.World.Effects
{
    ...
    [Serializable]
    public class AricPoisoned : Effect, ITierInitialized
    {
        ...
        public AricPoisoned(int Duration, string DamageIncrement, int Level, GameObject Owner = null, bool StartMessageUsePopup = false, bool StopMessageUsePopup = false)
            : this()
        {
